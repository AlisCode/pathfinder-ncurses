...
src/main: src/main.o src/casemap.o src/map.o src/pathfindermath.o src/menu.o src/mapwindow.o src/menuedition.o src/pathfindingnode.o src/pathfinding.o src/stateview.o
src/main.o:src/main.c src/map.h src/casemap.h src/menu.h src/mapwindow.h src/pathfinding.h src/stateview.h
